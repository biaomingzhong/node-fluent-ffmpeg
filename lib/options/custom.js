...
module.exports = function(proto) {
   ...
   */
  proto.addInputOption = proto.addInputOptions = proto.withInputOption = proto.withInputOptions = proto.inputOption = proto.inputOptions = function(
    options
  ) {
   ...
   * @return FfmpegCommand
   */
  proto.addOutputOption = proto.addOutputOptions = proto.addOption = proto.addOptions = proto.withOutputOption = proto.withOutputOptions = proto.withOption = proto.withOptions = proto.outputOption = proto.outputOptions = function(
    options
  ) {
    var doSplit = true;
  ...
  proto.filterGraph = proto.complexFilter = function(spec, map) {
    ...
    this._complexFilters(
      '-filter_complex',
      String.raw`"${utils.makeFilterStrings(spec).join(';')}"`
    );
